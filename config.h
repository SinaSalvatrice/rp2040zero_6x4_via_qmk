...
#define VIA_FIRMWARE_VERSION 13
...
// existing VIA keymap/macro addresses stable and reserve bytes 4044..4095
// for full 16-bit per-position tap-dance keycodes.
#define DYNAMIC_KEYMAP_EEPROM_MAX_ADDR 4043

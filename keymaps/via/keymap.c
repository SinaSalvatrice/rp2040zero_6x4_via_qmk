...
// LED 0 is reserved for the encoder/free LED. These five indices provide
// an always-visible layer marker after the RGB Matrix effect is rendered.
...
// Keep one unmistakable indicator LED on top of every RGB Matrix animation.
